...
vim.api.nvim_set_keymap('v', '<leader><leader>', ':OSCYank<CR>', { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '<C-j>', [[<cmd>:bprevious<CR>]], { noremap = true, silent = true })
...
-- vim.api.nvim_set_keymap('n', '<C-/>', "<cmd> lua require'hop'.hint_words({ hint_position = require'hop.hint'.HintPosition.END })<cr>", {})
vim.api.nvim_set_keymap('n', '<C- >', "<cmd> lua require'hop'.hint_words({ hint_position = require'hop.hint'.HintPosition.END })<cr>", {})
